#+latex_header:  \usepackage[left=3cm, right=3cm, top=3cm, bottom=3cm, headsep=1cm, footskip=1cm]{geometry}
...
#+latex_header: \def\columnseprulecolor{\color{lightgray}}
