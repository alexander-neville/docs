...
The unit of gravitational potential is the $Jkg^{-1}$ and like *GPE*, values are always negative. Gravitational potential can be expressed in terms of $r$ from a point mass or by the work done by positioning a mass at a point in a field.
