...
In section \textbf{\ref{pos:constant_current_charge}}, the capacitor was charged under constant current. A variable resistor was adjusted to do this. If a capacitor is charged through a system with *fixed* resistance, the same type of relationship seen during discharge is observed.
