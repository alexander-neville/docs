...
A proton-rich nucleus could also undergo /electron capture/. In this type of decay a proton changes into a neutron after capturing an inner shell electron. The nature of the /W boson/ is not significant/distinguishable.
...
As non-fundamental particles, the properties of hadrons can be determined by their /quark-composition/. The /charge/, /rest mass/ and /strangeness/ of a particle are determined by its combination of quarks. The three main types of quark are the /up/, /down/ and /strange/ quarks, each having a /baryon number/ of $+1/3$. For each of these quarks, there is a corresponding /antiquark/, with the opposite properties.
...
The baryons are a group of hadrons which are most commonly composed of three quarks. They have a baryon number of $1$ or $-1$ in the case of an /antibaryon/. These particles make up the nuclei of most atoms and constitute most of the mass in the universe. All baryons eventually decay into protons, the only stable baryon.
...
Where matter meets antimatter, specifically the correct /antiparticle/, rest energy can be released in a process called /annihilation/. The total rest mass of the two particles combined is converted into photon energy. Two photons are always produced to endure that the total difference in momentum is $0$.
...
The word /quantum/ refers to a measurable, discrete quantity of something. It was theorised that energy and EM waves, along with particles, are quantised.

*** Photoelectric Effect

The emission of electrons from the surface of a material which some electromagnetic radiation is incident on is described as the /photoelectric effect/. Any electrons removed from the surface of this material are called /photoelectrons/.
...
The photoelectric effect is demonstrated in the /vacuum photocell/ experiment. The photocell is a glass container housing a metal plate, called the /photocathode/, when *EM* radiation is incident on this plate, electrons are liberated and move the /anode/ on the opposite side of the photocell. The magnitude of the current in the circuit is proportional to the number of electrons reaching the anode, and hence the intensity of the light incident of the cathode.
...
An ion is a charged atom. Positive ions are produced by removing electrons from the atom. Negative ions are produced by adding electrons to the shells around an atom. /Ionisation/ is the process of producing ions.
...
During the /excitation/ of an electron, it is moved to a more energetic orbit, further from the atom. Unlike ionisation, electrons are not removed from the atom. Excitation may occur due to the collision of a fast moving electron with an orbitting electron, as shown on the left of figure \ref{img:electron_excitation}, or by the absorption of a photon, shown on the right of the same figure.
...
Electrons are bound to an atom by the electrostatic force of attraction to the positively charged nucleus. Electrons may only orbit in specific positions or shells. The energy of electrons in these shells is fixed and movement between them requires exact, /discrete/ amounts of energy. The energy required for an electron to move between shells must be delivered or emitted in a single burst.

During excitation, an electron is moved to a higher orbit, either due to collision from another electron or the absorption of a photon. This change places the atom in a heightened /energy level/. Eventually the electron will move back down to its original orbit, releasing a photon of predictable energy in a process known as /de-excitation/.
...
The diagram in figure \ref{img:energy_levels}, illustrates the /energy levels/ of a hypothetical atom. Each energy level, labelled on the right, is a different electronic configuration. The /ionisation level/ is the zero reference point and the lowest energy state of the atom is called the /ground state/. As energy is /required/ to move the atom into a higher energy state, energy levels are negative and increase towards the ionisation level. For a change to occur, an amount of energy equal to the difference between the current energy level and any other must be absorbed or emitted.
...
Following excitation by a photon of $8eV$, the atom in figure \ref{img:energy_levels}, de-excites by the emission of three less energetic photons, gradually descending through the energy levels. This phenomena is the basis of /fluorescence/, where high energy *UV* photons are absorbed by fluorescent materials and the energy is released in stages as less energetic visible light photons.
...
The diffraction of light and the photoelectric effect demonstrate light's dual particle and wave-like nature. Some particles behave the same way and have wave-like properties. The /de Broglie/ hypothesis states that the wave-like nature of a matter particle is characterised by its wavelength.
...
The /gravitational potential energy/ is the energy of an object due to its position in a gravitational field. The /gravitational potential/ at a point in a gravitational field is the /gravitational potential energy/ per unit mass of a small test mass. It can also be described as the work done per unit mass to move an object from infinite distance to that point. Some more points:
...
The unit of gravitational potential is the $Jkg^{-1}$ and like *GPE*, values are always negative. Gravitational potential is defined as the work done per unit mass, as shown on the left. It can also be expressed in terms of $r$ from a point mass, as is the case on the right.
...
Seeing as *RHS* is a constant, the value of $r^3/T^2$ is also constant for all planets. The *KE* and *PE* of an orbiting satellite are as follows:
...
*** Charge & Energy Stored in a Capacitor
#+begin_export latex
...
An important quantity in the discharge or charge of a capacitor is the /Time Constant/, $\tau$. Its value is the product of $R$, the resistance of the fixed resistor, and $C$, the capacitance of the capacitor, according to $\tau = RC$. When the time $t$ equals $\tau$, any observed quantity of the discharging capacitor arrangement will have fallen to $e^{-1} \approx 0.37$ its initial value.

*** Charging Through a Fixed Resistor

In section $\ref{pos:constant_current_charge}$, the capacitor was charged under constant current. A variable resistor was adjusted constantly to achieve this. If a capacitor is charged through a system with *fixed* resistance, the same type of relationship seen during discharge is observed. The potential difference across the capacitor will increase to the *PD* of the circuit's source of *EMF*. The charge stored on the capacitor will increase during this time, at a rate which decreases with time. Charging current, on the other hand, will decrease gradually as the potential difference of the capacitor grows.

The charging curve for potential difference and charge are asymptotic to the initial circuit value and are the reflection of the exponential decay curve in this line. In the equations below, $V_0$ and $CV_0$ have been factorised from the terms on the *RHS*. The time constant is of similar significance in these relationships, where $\tau$ is equal to the point where the charge or potential difference is $0.63$, or $1 - 0.37$, its final value.
...
A magnetic field surrounds any magnet or current carrying-wire, acting on another magnet or current-carrying wire. The magnetic field around a bar magnet is strongest at the poles. These poles may be /north-seeking/ or /south-seeking/, depending on the way they align themselves with earths magnetic field. Field lines in a magnetic field illustrate the direction a north pole would move.

*** Motor Effect

A wire carrying an electric current is placed at a non-zero angle to the field lines of an external magnetic field will experience a force due to its position in the field. This is known as the /Motor Effect/. This force is greatest when the direction of travel of the current is perpendicular to the lines of force. The magnitude of this force will decrease to zero if the angle is reduced to zero. The magnitude of the force experienced is related to three factors: /magnetic flux density/; the current in the wire and the length of wire in the field, according to:
...
If a single wire is placed such in a magnetic field, the force produced will move the wire out of the field. If a rectangular /coil/, free to rotate in the plane parallel to the magnetic field lines, is placed in the same field, a /couple/ of forces are produced, which will cause rotation about this axis.
...
The magnetic flux of a field is the product of flux density, $B$, and the given perpendicular area. Magnetic flux linkage is the product of magnetic flux and the number of turns in a coil. The unit of magnetic flux is the *weber* $(Wb)$.
...
There are numerous specific examples of electromagnetic induction. For the most part, it is simply applying $BA/\Delta t$ to calculate the *EMF*. For example the *EMF* due to a conductor (wire) moving through a field is $Bl \Delta s / \Delta t$, which can be simplified to $Blv$. For a rectangular coil with $N$ turns undergoing the same motion, its EMF is $BNlv$. For a fixed coil in a changing magnetic field, the induced force is $AN \Delta B/ \Delta t$.
...
When current is passed through a coil arrangement, a magnetic field is produced. This can be verified with a plotting compass. For a large coil or /solenoid/ arrangement, this field resembles the field seen around a bar magnet. For illustrative purposes, current appears to flow *anticlockwise around the "north pole" of the solenoid* when viewed from outside.

*** Alternating Current

Induced *EMF* is alternating, so it changes in direction periodically. As seen above *EMF* is modelled with a $\sin$ function, therefore the graph of *EMF* against time is a sinusoidal curve. In a single cycle, the current or *EMF* is seen to move one way and then the other. The frequency of an alternating current is the number of these cycles per second.

When displayed on an oscilloscope, various measurements of an alternating current *EMF* can be measured. The /peak voltage/ is the displacement from equilibrium to the highest or lowest measured voltage, labelled $V_0$. The /peak-to-peak/ voltage is effectively double $V_0$, the difference between the highest measured voltage and the corresponding minimum.

The /root mean square/ voltage is the average of the squares of all possible voltages. This can be calculated from $V_0$. The root mean square current is also measured in the same way.
...
A transformer is a device which is able to change the peak voltage of an alternating current. The device has two coils surrounding an ferrous iron core. The first or /primary/ coil is connected to the input voltage. The changing current in the wire causes an alternating magnetic field in the core. An *EMF* is induced in the secondary coil, due to the changing magnetic flux, according to $\epsilon = AN \Delta B/\Delta t$.
...
Atoms which are not considered stable emit /radiation/. Radiation is the emission of energy and is often /electromagnetic/ or as particles. Radiation is sometimes considered frightening or alarming among the general population, although it has many industrial and medical uses.
...
A classical interpretation of wave theory, devised by Rayleigh and Jeans, linked the intensity of radiation at a given frequency and temperature to $f^2$. This expression would suggest that the intensity of radiation would rise dramatically at high frequencies, leading to a situation described as the /ultraviolet catastrophe/.
...
An inertial frame of reference is not undergoing acceleration, it is at constant velocity. Einstein's theory of special relativity applies to these frames of reference with certain assumptions, called /postulates/. The first postulate is that the speed of light in free space is invariant. The second is that the laws of physics are the same in all inertial frames of reference.
...
Mass and Energy are proven to be interchangeable, according to $E=mc^2$. Supplying more energy to an object will increase its mass, therefore the mass of an object increases at speed. Resulting values of mass are the /relativistic mass/, $m$.
